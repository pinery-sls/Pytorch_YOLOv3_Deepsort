...
from yolov3.utils.datasets import LoadImages, LoadStreams
from yolov3.utils.general import check_img_size, non_max_suppression, scale_coords, check_imshow, xyxy2xywh
from yolov3.utils.torch_utils import select_device, time_synchronized
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str, default='yolov3/weights/yolov3.pt', help='model.pt path')
